//Obteniedno la informacion por medio del DOM y los IDs
...
if(window.location.href.endsWith("registro-medicos.html")){
     ...
     formularioMedicos.addEventListener("submit",function(event){
          ...
          const medico=new Usuario(
               valorNombres,valorApellidos, valorCedula, valorTelefono, valorEspecialidad);
...
if(window.location.href.endsWith("registro-pacientes.html")){
     //El evento para formularioPacientes va a ser de tipo enviar o guardar es decir submit
